...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='Unnamed', max_length=60, unique=True, verbose_name='Имя')),
                ('description', models.TextField(blank=True, default='Unnamed', max_length=250, null=True, verbose_name='Описание')),
            ...
            options={
                ...
                'ordering': ['created_at'],
                'permissions': [('can_unpublish_products', 'Can unpublish products')],
            },
        ),
    ]
